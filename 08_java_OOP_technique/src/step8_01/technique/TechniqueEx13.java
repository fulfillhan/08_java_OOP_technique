...
class OrderDTO{ //dto압축파이 같은 느낌
	...
	@Override  // toString 원래 있는 메서드이므로 재정의한다.
...
public class TechniqueEx13 {
	...
	public static void main(String[] args) {
		...
		order1.setGoodsId("order1");
		order1.setMemberId("goods1");
...
//		System.out.println(order1.getOrderId());
		...
		//System.out.println(order1.toString()); -> 이렇게 사용도 가능.
